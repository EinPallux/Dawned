...
| Q25 | Resource-node schema          | **Answered by P10 starting** — the recommended default was "leave it until the professions phase", and that is the phase now under way. `resourceNodeSchema` is a P10-A deliverable and the map editor's node layer gets its tool with it                                                                                      | ROADMAP P10-A, PROFESSIONS.md §1.4                                     |
