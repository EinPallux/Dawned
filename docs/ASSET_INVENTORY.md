...
| **Ultimate Fantasy Buildings Kit** (128)                                                | Dawnhaven & village buildings — **22 baked at P12-B** (see CREDITS for the license judgement: no in-folder license, shipped as its Quaternius siblings' CC0)                      |
| **Medieval Village Pack** (88)                                                          | **NOT USED** — no license file, FBX/OBJ only, unattributable (same call as Gems & Ores at P10). Sungraze's farmsteads come from the Buildings Kit's `Farm_*`/`Windmill_*` instead |
